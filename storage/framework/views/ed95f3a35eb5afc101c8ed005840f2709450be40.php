<div class="quote_product_structure quote_supp_item position-relative<?php echo e($supp_index > 0 ? ' mt-4 border_green p-3 radius_5' : ''); ?>" data-index=<?php echo e(@$supp_index ?? 0); ?>>
    ...
    <?php else: ?> 
        <input type="hidden" value="1" name="product[<?php echo e($pro_index); ?>]['.$key_supp.'][<?php echo e($supp_index); ?>][main]">
    <?php endif; ?>
    <div class="mb-2 paper_product_config">
        ...
        <?php
            $pro_paper_name = [
                ...
                'note' => 'Tên SP giấy in',
                'value' => @$supp_name,
                'attr' => ['required' => 1, 'inject_class' => $supp_index == 0 ? 'quote_receive_paper_name_main' : 'quote_receive_paper_name_ext']
            ] 
        ?>
