                ...
                <div class="col-lg-6">
                    ...
                    <div class="row row-7">
                        ...
                        <div class="col-lg-6 mb-3">
                            <a href=<?php echo e(asset('view/'.$command['table'].'?default_data=%7B"status"%3A"'.@$command['status'].'"%7D')); ?> 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/td-company-app/resources/views/main.blade.php ENDPATH**/ ?>