...
<div class="mt-2 pt-2 border_top_thin formula_tab">
    ...
    <div class="formula_item d-flex align-items-center color_brown mb-1">
        ...
        <div class="formula_content d-flex align-items-center">
            <p class="formula_param mx-2">
                Dài (<?php echo e($size['length']); ?>) x Rộng x ĐG chất liệu cán x SL tờ in cả BH  x Số mặt cán
            </p>
    ...
    <p class="fs-15 color_red font_bold">Tổng chi phí cho máy cán: (1) + (2) + (3) + (4) = <?php echo e(number_format($stage['total'])); ?>đ</p>       
</div><?php /**PATH /home/dell/Desktop/code/td-company-app/resources/views/quotes/profits/papers/nilon.blade.php ENDPATH**/ ?>