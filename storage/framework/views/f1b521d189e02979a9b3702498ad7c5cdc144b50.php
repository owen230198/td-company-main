...
<div class="mt-2 pt-2 border_top_thin formula_tab">
    ...
    <div class="formula_item d-flex align-items-center color_brown mb-1">
        ...
        <div class="formula_content d-flex align-items-center">
            ...
            <p class="font_bold formula_result"> = <?php echo e($stage['qty_pro']); ?> x <?php echo e($stage['work_price']); ?></p>
...
</div><?php /**PATH /home/dell/Desktop/code/td-company-app/resources/views/quotes/profits/supplies/peel.blade.php ENDPATH**/ ?>