    ...
    <div class="mt-2 pt-2 border_top_thin formula_tab">
        ...
        <div class="formula_item d-flex align-items-center color_brown mb-1">
            ...
            <div class="formula_content d-flex align-items-center">
                ...
                <p class="font_bold formula_result mr-2"> = (<?php echo e($stage['price']); ?> x <?php echo e($stage['qty_pro']); ?>) x (<?php echo e($stage['nqty']); ?> x <?php echo e($stage['shape_price']); ?>)</p>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\td-company-app\resources\views/quotes/profits/papers/float.blade.php ENDPATH**/ ?>