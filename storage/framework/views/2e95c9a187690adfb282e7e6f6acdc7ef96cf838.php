...
<h3 class="fs-14 text-uppercase border_top_eb pt-3 mt-3 mb-4 text-center handle_title d-flex align-items-center justify-content-center">
    ...
    <?php if(!empty($supply_obj->id)): ?>
        <a href="<?php echo e(url('print-data/fill_finishes/'.$supply_obj->id)); ?>" target="_blank" class="main_button color_white bg_green border_green radius_5 font_bold sooth">
...
<?php echo $__env->make('view_update.view', $data_magnet_qty, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/td-company-app/resources/views/quotes/products/fill_finishes/ajax_view.blade.php ENDPATH**/ ?>