...
<?php $__env->startSection('process'); ?>
    ...
    <?php echo $__env->make('orders.users.6.supply_handles.handle', ['compen_percent' => $decal_compen_percent], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
