<div class="group_class_view <?php echo e(@$other_data['group_class']); ?> col-<?php echo e(@$other_data['width'] ?? '12'); ?>" <?php echo e(@$other_data['inject_attr']); ?>>
    <div class="row">
        <?php $__currentLoopData = $child; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field_child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-<?php echo e(@$other_data['width_child'] ?? '6'); ?> align-self-center">
