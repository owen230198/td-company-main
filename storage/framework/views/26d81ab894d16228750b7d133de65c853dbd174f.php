<?php
    $pro_fill_finish_qty = [
        'name' => 'product['.$j.'][fill_finish][qty]',
        'note' => 'Số lượng',
        'value' => @$pro_qty,
        'attr' => ['type_input' => 'number', 'required' => 1,]
    ];
    $pro_fill_ext = [
        'name' => 'product['.$j.'][fill_finish][fill][ext_price]',
    ...
    $pro_finish_ext = [
        'name' => 'product['.$j.'][fill_finish][finish][ext_price]',
    ...
    $data_select_magnet = [
        'other_data' => [
            'data' => ['table' => 'fill_finish_prices', 'where' => ['type' => \App\Constants\TDConstant::MAGNET]]
        ],
    ...
    $data_magnet_qty = [
        'name' => 'product['.$j.'][fill_finish][magnet][qty]',
...
<div class="module_fill_quote pb-2 mb-2 border_bot_eb section_quote_fill_finish">
    <div class="d-flex align-items-end list_item_fill_finish">
        ...
        <button type="button" data-product="<?php echo e($j); ?>" data-view="ajax_fill"
...
<div class="module_finish_quote pb-2 mb-2 border_bot_eb section_quote_fill_finish">
    <div class="d-flex align-items-end list_item_fill_finish">
        ...
        <button type="button" data-product="<?php echo e($j); ?>" data-view="ajax_finish" 
...
<?php echo $__env->make('view_update.view', $data_magnet_qty, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\td-company-app\resources\views/quotes/products/fill_finishes/view.blade.php ENDPATH**/ ?>