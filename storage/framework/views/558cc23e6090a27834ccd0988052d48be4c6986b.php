<div class="mb-2 paper_product_config">
    ...
    <?php echo $__env->make('quotes.products.supplies.title_config', ['divide' => $carton_divide, 'name' => 'carton'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php echo $__env->make('quotes.products.select_device', 
    ['key_device' => $key_device_mill, 'note' => 'Máy phay', 'value' => getDeviceIdByKey($key_device_mill), 'element' => $key_supp], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
