...
<div class="mt-2 pt-2 border_top_thin formula_tab">
    ...
    <div class="formula_item d-flex align-items-center color_brown mb-1">
        ...
        <div class="formula_content d-flex align-items-center">
            <p class="formula_param mx-2">
                Dài (<?php echo e($size['length']); ?>) x Rộng x ĐG vật tư x SL sản phẩm cả BH
            </p>
            <p class="font_bold formula_result mr-2"> = <?php echo e($size['length']); ?> x <?php echo e($size['width']); ?> x 0 x <?php echo e($stage['qty_pro']); ?></p>
            <p class="font_bold formula_result"> = <?php echo e(number_format($size['length'] * $size['width'] * 0 * $stage['qty_pro'])); ?>đ</p>
        </div>
    </div>   
    <div class="formula_item d-flex align-items-center color_brown mb-1">
    ...
    <div class="formula_item d-flex align-items-center color_brown mb-1">
        ...
        <div class="formula_content d-flex align-items-center">
            ...
            <p class="font_bold formula_result"> = <?php echo e($stage['qty_pro']); ?> x <?php echo e($stage['work_price']); ?> x <?php echo e($factor); ?></p>
            <p class="font_bold formula_result"> = <?php echo e(number_format($stage['qty_pro'] * $stage['work_price'] * $factor)); ?>đ</p>
        </div>
    </div>
    <p class="fs-15 color_red font_bold">Tổng chi phí: (1) + (2) + (3) + (4) = <?php echo e(number_format($stage['total'])); ?>đ</p>       
</div><?php /**PATH /home/dell/Desktop/code/td-company-app/resources/views/quotes/profits/supplies/mill.blade.php ENDPATH**/ ?>