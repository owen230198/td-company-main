...
<?php $__env->startSection('items'); ?>
    <?php echo $__env->make('orders.users.6.supply_handles.view_handles.squares.item', ['note' => $note], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
