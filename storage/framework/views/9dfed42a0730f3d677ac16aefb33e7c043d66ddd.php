            ...
            <?php if($fstage['cost'] > 0): ?>
                <li class="mb-1 pb-1">
                    ...
                    <div class="mb-2 d-flex align-items-center">
                        ...
                        <p class="font_bold"><?php echo e(getFieldDataById('name', 'materals', @$fstage['materal'])); ?></p>
                    </div>
                    <div class="mb-2 d-flex align-items-center">
                    ...
                    <div class="mb-2 d-flex align-items-center">
                        ...
                        <p class="font_bold color_red">
                            ...
                            ((<?php echo e($fstage['length']); ?> x <?php echo e($fstage['width']); ?> x <?php echo e($fstage['qttv_price']); ?> + <?php echo e((float) @$fstage['work_price']); ?>) x <?php echo e($stage['qty_pro']); ?>) + <?php echo e((float) @$fstage['shape_price']); ?>
...
</div><?php /**PATH /home/dell/Desktop/code/td-company-app/resources/views/quotes/profits/fill_finishes/fill.blade.php ENDPATH**/ ?>