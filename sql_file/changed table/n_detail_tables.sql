...
INSERT INTO `n_detail_tables` VALUES (77, 'code', '{\"disable_field\":1,\"required\":1}', 'Mã đơn', 'text', 'orders', 1, 0, 1, 1, 0, '', 1, 4, 1, '2023-05-26 03:19:12', '2024-04-23 16:31:53');
INSERT INTO `n_detail_tables` VALUES (78, 'list_product', '', 'Sản phẩm', 'child_linking', 'orders', 1, 0, 1, 1, 0, '{\r\n	\"config\":{\r\n		\"search\":1\r\n	},\r\n	\"data\":{\r\n		\"table\":\"products\",\r\n		\"field_query\":\"order\"\r\n	}\r\n}', 1, 1, 1, '2023-05-26 03:19:12', '2024-04-23 07:15:15');
INSERT INTO `n_detail_tables` VALUES (79, 'status', '', 'Trạng thái', 'select', 'orders', 1, 0, 1, 1, 0, '{\"data\":{\r\n		\"options\":{\r\n			\"\":\"Trạng thái đơn\", \r\n			\"not_accepted\":\"Chưa duyệt\", \r\n			\"accepted\":\"Đã duyệt thiết kế\", \r\n			\"to_design\":\"Chờ thiết kế nhận lệnh\",\r\n			\"designing\":\"Đang thiết kế\",\r\n			\"design_submited\":\"Đã xong thiết kế\",\r\n			\"tech_submited\":\"Kế hoạch đang xử lí\",\r\n			\"making_process\":\"Đang gia công\",\r\n			\"submited\":\"hoàn thành gia công\",\r\n			\"finished\":\"Đã thu tiền\"\r\n		}\r\n	}\r\n}', 1, 9, 1, '2023-05-26 03:19:12', '2024-04-23 16:32:47');
INSERT INTO `n_detail_tables` VALUES (80, 'advance', '{\"type_input\":\"price\"}', 'Tạm ứng', 'text', 'orders', 1, 0, 1, 0, 0, '', 1, 10, 1, '2023-05-26 03:19:12', '2024-04-23 16:32:54');
INSERT INTO `n_detail_tables` VALUES (81, 'rest', '{\"type_input\":\"price\"}', 'Tổng tiền', 'text', 'orders', 1, 0, 1, 0, 0, '', 1, 11, 1, '2023-05-26 03:19:12', '2024-04-23 16:33:45');
INSERT INTO `n_detail_tables` VALUES (82, 'created_at', '', 'Ngày nhận hàng', 'datetime', 'orders', 1, 0, 1, 1, 0, '', 1, 5, 1, '2023-05-26 03:19:12', '2024-04-23 16:33:16');
INSERT INTO `n_detail_tables` VALUES (83, 'created_by', '', 'Kinh doanh', 'linking', 'orders', 1, 0, 1, 1, 0, '{\r\n	\"config\":{\r\n		\"search\":1\r\n	},\r\n	\"data\":{\r\n		\"table\":\"n_users\"\r\n	}\r\n}', 1, 7, 1, '2023-05-26 03:19:12', '2024-04-23 16:32:29');
...
INSERT INTO `n_detail_tables` VALUES (86, 'name', '', 'Sản phẩm', 'text', 'c_designs', 1, 0, 1, 1, 0, '', 1, 0, 1, '2023-06-15 06:55:51', '2024-03-05 22:07:59');
...
INSERT INTO `n_detail_tables` VALUES (92, 'size_type', '{\"required\":1,\"readonly\":1,\"inject_class\":\"__wh_select_size\"}', 'Loại vật tư', 'linking', 'c_supplies', 1, 0, 0, 0, 148, '{\r\n	\"config\":{\r\n		\"search\":1\r\n	},\r\n	\"data\":{\r\n		\"table\":{\r\n			\"getFunc\":\"getTableWarehouseByType\"\r\n		}\r\n	}\r\n}', 1, 1, 1, '2023-07-14 02:55:31', '2024-03-05 13:53:09');
INSERT INTO `n_detail_tables` VALUES (93, 'qty', '{\"required\":1, \"type_input\":\"number\"}', 'SL cần xuất', 'text', 'c_supplies', 1, 1, 1, 0, 0, '', 1, 1, 1, '2023-07-14 02:55:32', '2023-12-12 22:55:17');
...
INSERT INTO `n_detail_tables` VALUES (95, 'name', '', 'Sản phẩm', 'text', 'c_supplies', 1, 1, 1, 1, 0, '', 1, 0, 1, '2023-07-14 03:16:25', '2024-03-05 14:56:50');
INSERT INTO `n_detail_tables` VALUES (96, 'status', '', 'Trạng thái', 'select', 'c_supplies', 0, 0, 1, 0, 0, '{\r\n		\"data\":{\r\n				\"options\":{\"\":\"Chưa gửi yêu cầu xuất\", \"handling\":\"Đang chờ xuất kho\", \"handled\":\"Đã xuất kho\"}\r\n		}\r\n}', 1, 1, 1, '2023-07-14 02:50:55', '2023-12-12 22:56:25');
...
INSERT INTO `n_detail_tables` VALUES (129, 'name', '{\"disable_field\":1}', 'Tên vật tư', 'text', 'supply_warehouses', 0, 0, 1, 0, 0, '', 1, 0, 1, '2023-04-07 23:41:47', '2024-05-03 12:23:07');
INSERT INTO `n_detail_tables` VALUES (130, 'length', '{\"required\":1}', 'KT dài', 'text', 'supply_warehouses', 1, 0, 0, 0, 329, '', 1, 1, 1, '2023-04-07 23:41:47', '2024-05-03 12:21:21');
INSERT INTO `n_detail_tables` VALUES (131, 'width', '{\"required\":1}', 'KT rộng', 'text', 'supply_warehouses', 1, 0, 0, 0, 329, '', 1, 2, 1, '2023-04-07 23:41:47', '2024-05-03 12:21:19');
INSERT INTO `n_detail_tables` VALUES (132, 'qty', '{\"type_input\":\"number\",\"disable_field\":1}', 'Số lượng', 'text', 'supply_warehouses', 1, 0, 1, 0, 0, '', 1, 3, 1, '2023-04-30 11:00:22', '2024-04-26 20:20:49');
...
INSERT INTO `n_detail_tables` VALUES (134, 'supp_price', '{\"required\":1,\"inject_class\":\"__select_child\"}', 'Định lượng', 'linking', 'supply_warehouses', 1, 0, 0, 0, 135, '{\r\n	\"config\":{\r\n		\"searchbox\":1\r\n	},\r\n	\"data\":{\r\n		\"table\":\"supply_prices\"\r\n	}\r\n}', 1, 0, 1, '2023-05-11 11:18:58', '2024-04-26 18:56:01');
INSERT INTO `n_detail_tables` VALUES (135, 'group_supply', '', 'Dạng vật tư', 'group', 'supply_warehouses', 1, 1, 0, 1, 0, '{\r\n	\"group_class\":\"__module_select_ajax_value_child\",\r\n	\"inject_attr\":\"link=option-ajax-child/supply_prices/supply_id\",\r\n	\"width\":\"8\",\r\n	\"width_child\":\"6\"\r\n}', 1, 0, 1, '2023-05-23 14:41:40', '2024-05-03 12:22:07');
...
INSERT INTO `n_detail_tables` VALUES (140, 'name', '{\"disable_field\":1}', 'Tên vật tư', 'text', 'print_warehouses', 0, 0, 1, 0, 0, '', 1, 0, 1, '2023-04-07 23:41:47', '2024-05-03 12:11:51');
INSERT INTO `n_detail_tables` VALUES (141, 'length', '{\"required\":1, \"class_on_search\":\"change_submit\"}', 'KT dài', 'text', 'print_warehouses', 1, 0, 0, 0, 328, '', 1, 2, 1, '2023-04-07 23:41:47', '2024-04-26 18:43:42');
INSERT INTO `n_detail_tables` VALUES (142, 'width', '{\"required\":1, \"class_on_search\":\"change_submit\"}', 'KT rộng', 'text', 'print_warehouses', 1, 0, 0, 0, 328, '', 1, 3, 1, '2023-04-07 23:41:47', '2024-04-26 18:43:45');
...
INSERT INTO `n_detail_tables` VALUES (144, 'supp_price', '', 'Loại giấy', 'linking', 'print_warehouses', 1, 0, 0, 0, 327, '{\r\n	\"config\":{\r\n		\"search\":1\r\n	},\r\n	\"data\":{\r\n		\"table\":\"materals\",\r\n		\"where_default\":{\"type\":\"type\"}\r\n	}\r\n}', 1, 0, 1, '2023-05-11 11:18:58', '2024-04-25 22:28:10');
INSERT INTO `n_detail_tables` VALUES (145, 'name', '{\"disable_field\":1}', 'Tên vật tư', 'text', 'other_warehouses', 0, 0, 1, 0, 0, '', 1, 0, 1, '2023-04-07 23:41:47', '2024-05-03 12:29:45');
INSERT INTO `n_detail_tables` VALUES (146, 'qty', '{\"type_input\":\"number\",\"disable_field\":1}', 'Số lượng', 'text', 'other_warehouses', 1, 0, 1, 0, 0, '', 1, 1, 1, '2023-04-30 11:00:22', '2024-05-02 22:06:30');
INSERT INTO `n_detail_tables` VALUES (147, 'supp_price', '{\"required\":1}', 'Loại nam châm', 'linking', 'other_warehouses', 1, 1, 0, 1, 0, '{\r\n	\"config\":{\r\n		\"search\":1\r\n	},\r\n	\"data\":{\r\n		\"table\":\"materals\",\r\n		\"where_default\":{\"type\":\"type\"}\r\n	}\r\n}', 1, 0, 1, '2023-05-11 11:18:58', '2024-05-03 12:29:59');
...
INSERT INTO `n_detail_tables` VALUES (150, 'name', '{\"disable_field\":1}', 'Tên vật tư', 'text', 'square_warehouses', 0, 0, 1, 1, 0, '', 1, 0, 1, '2023-04-07 23:41:47', '2024-05-03 11:48:19');
...
INSERT INTO `n_detail_tables` VALUES (152, 'supp_price', '{\"required\":1}', 'Loại vật tư', 'linking', 'square_warehouses', 1, 1, 0, 1, 0, '{\r\n	\"config\":{\r\n		\"search\":1\r\n	},\r\n	\"data\":{\r\n		\"table\":\"materals\",\r\n		\"where_default\":{\"type\":\"type\"}\r\n	}\r\n}', 1, 0, 1, '2023-05-11 11:18:58', '2024-05-03 11:46:32');
INSERT INTO `n_detail_tables` VALUES (153, 'created_by', NULL, 'Người thêm', 'linking', 'other_warehouses', 1, 0, 0, 0, 0, '{\r\n	\"config\":{\r\n		\"search\":1\r\n	},\r\n	\"data\":{\r\n		\"table\":\"n_users\"\r\n	}\r\n}', 1, 2, 1, '2023-04-08 00:08:00', '2024-05-02 22:06:36');
INSERT INTO `n_detail_tables` VALUES (154, 'created_at', NULL, 'Ngày thêm', 'datetime', 'other_warehouses', 1, 0, 0, 0, 0, '', 1, 3, 1, '2023-04-08 00:08:00', '2024-05-02 22:06:39');
INSERT INTO `n_detail_tables` VALUES (155, 'created_by', NULL, 'Người thêm', 'linking', 'square_warehouses', 1, 0, 0, 0, 0, '{\r\n	\"config\":{\r\n		\"search\":1\r\n	},\r\n	\"data\":{\r\n		\"table\":\"n_users\"\r\n	}\r\n}', 1, 4, 1, '2023-04-08 00:08:00', '2024-04-26 18:51:44');
INSERT INTO `n_detail_tables` VALUES (156, 'created_at', NULL, 'Ngày thêm', 'datetime', 'square_warehouses', 1, 1, 1, 0, 0, '', 1, 3, 1, '2023-04-08 00:08:00', '2024-04-26 18:51:40');
INSERT INTO `n_detail_tables` VALUES (157, 'order', NULL, 'Đơn hàng', 'linking', 'products', 0, NULL, NULL, 1, 0, '{\r\n	\"config\":{\r\n		\"search\":1\r\n	},\r\n	\"data\":{\r\n		\"table\":\"orders\",\r\n		\"field_title\":\"code\"\r\n	}\r\n}', 1, 0, 1, '2023-08-22 03:54:31', '2023-12-28 23:53:17');
...
INSERT INTO `n_detail_tables` VALUES (159, 'name', '', 'Tên', 'text', 'products', 1, 0, 1, 1, 0, '', 1, 1, 1, '2023-05-26 03:19:12', '2024-01-03 09:44:25');
...
INSERT INTO `n_detail_tables` VALUES (161, 'qty', '{\"type_input\":\"number\",\"required\":1}', 'Số lượng sx', 'text', 'products', 1, 1, 1, 0, 0, '', 1, 2, 1, '2023-04-30 11:00:22', '2024-01-03 09:44:53');
INSERT INTO `n_detail_tables` VALUES (162, 'total_amount', '{\"type_input\":\"price\"}', 'Tổng giá', 'text', 'products', 1, 0, 1, 0, 0, '', 1, 3, 1, '2023-05-26 03:19:12', '2024-03-21 16:41:39');
...
INSERT INTO `n_detail_tables` VALUES (165, 'width', '{\"required\":1}', 'Kích thước khổ', 'text', 'square_warehouses', 1, 1, 0, 1, 0, '', 1, 1, 1, '2023-04-30 11:00:22', '2024-05-03 11:47:29');
INSERT INTO `n_detail_tables` VALUES (166, 'qtv', '', 'Định lượng', 'text', 'print_warehouses', 1, 0, 0, 0, 327, '{\r\n		\"config\":{\r\n				\"search\":1,\r\n				\"direct_show\":1\r\n		},\r\n		\"data\":{\r\n				\"options\":{\"\":\"Chọn định lượng\"}\r\n		}\r\n}', 1, 1, 1, '2023-04-30 11:00:22', '2024-04-25 22:28:01');
...
INSERT INTO `n_detail_tables` VALUES (217, 'bag_paste', '', 'Dán túi', 'handle_stage', 'papers', 1, 0, 0, 0, 0, '', 1, 0, 1, '2023-04-07 23:41:47', '2023-12-25 20:59:00');
...
INSERT INTO `n_detail_tables` VALUES (219, 'name', '', 'Tên vật tư', 'text', 'supplies', 0, 0, 0, 0, 0, '', 1, 0, 1, '2023-04-07 23:41:47', '2023-12-26 14:35:23');
...
INSERT INTO `n_detail_tables` VALUES (268, 'product', '', 'Sản phẩm', 'linking', 'c_expertises', 1, 0, 1, 1, 0, '{\r\n	\"config\":{\r\n		\"search\":1\r\n	},\r\n	\"data\":{\r\n		\"table\":\"products\"\r\n	}\r\n}', 1, 0, 1, '2023-06-15 06:55:51', '2024-01-03 03:56:01');
INSERT INTO `n_detail_tables` VALUES (269, 'take_status', '', 'Kiểu nhập kho', 'select', 'c_expertises', 1, 0, 1, 0, 0, '{\"data\":{\r\n		\"options\":{\"full\":\"Nhập kho đủ\", \"prob\":\"Nhập kho thiếu do lỗi kỹ thuật\"}\r\n	}\r\n}', 1, 0, 1, '2023-06-15 06:55:51', '2024-01-03 03:56:01');
...
INSERT INTO `n_detail_tables` VALUES (305, 'price', '{\"type_input\":\"price\"}', 'Đơn giá', 'calc_price', 'products', 1, 0, 0, 0, 0, '', 1, 3, 1, '2023-05-26 03:19:12', '2024-03-21 16:41:48');
INSERT INTO `n_detail_tables` VALUES (306, 'code', '{\"disable_field\":1}', 'Mã lệnh', 'text', 'after_prints', 1, 0, 1, 1, 0, '', 1, 0, 1, '2023-06-15 06:55:51', '2024-03-26 22:21:18');
INSERT INTO `n_detail_tables` VALUES (307, 'name', '{\"disable_field\":1}', 'Tên', 'text', 'after_prints', 1, 0, 1, 1, 0, '', 1, 0, 1, '2023-06-15 06:55:51', '2024-03-26 22:21:18');
INSERT INTO `n_detail_tables` VALUES (308, 'qty', '{\"required\":1, \"type_input\":\"number\"}', 'Số lượng', 'text', 'after_prints', 1, 1, 1, 0, 0, '', 1, 0, 1, '2023-07-14 02:55:32', '2024-03-26 22:21:18');
INSERT INTO `n_detail_tables` VALUES (309, 'worker', '', 'Công nhân', 'linking', 'after_prints', 1, 0, 1, 1, 0, '{\r\n	\"config\":{\r\n		\"search\":1\r\n	},\r\n	\"data\":{\r\n		\"table\":\"w_users\"\r\n	}\r\n}', 1, 0, 1, '2023-06-15 06:55:51', '2024-03-26 22:21:18');
INSERT INTO `n_detail_tables` VALUES (310, 'status', '', 'Trạng thái', 'select', 'after_prints', 1, 0, 1, 0, 0, '{\"data\":{\r\n		\"options\":{\"processing\":\"Chờ KCS\", \"submited\":\"Đã xử lí\"}\r\n	}\r\n}', 1, 0, 1, '2023-06-15 06:55:51', '2024-03-26 22:21:59');
INSERT INTO `n_detail_tables` VALUES (311, 'created_at', '', 'Ngày gửi', 'datetime', 'after_prints', 1, 0, 1, 1, 0, '', 1, 0, 1, '2023-06-15 06:55:51', '2024-01-03 03:56:01');
INSERT INTO `n_detail_tables` VALUES (312, 'code', '{\"disable_field\":1}', 'Mã lệnh', 'text', 'c_reworks', 1, 0, 1, 1, 0, '', 1, 0, 1, '2023-06-15 06:55:51', '2024-04-04 00:18:56');
INSERT INTO `n_detail_tables` VALUES (313, 'name', '{\"disable_field\":1}', 'Tên', 'text', 'c_reworks', 1, 0, 1, 1, 0, '', 1, 0, 1, '2023-06-15 06:55:51', '2024-04-04 00:18:56');
INSERT INTO `n_detail_tables` VALUES (314, 'product', '', 'Sản phẩm sx lại', 'linking', 'c_reworks', 1, 0, 1, 1, 0, '{\r\n	\"config\":{\r\n		\"search\":1\r\n	},\r\n	\"data\":{\r\n		\"table\":\"products\"\r\n	}\r\n}', 1, 1, 1, '2023-06-15 06:55:51', '2024-04-09 23:20:37');
INSERT INTO `n_detail_tables` VALUES (315, 'type', '', 'Khâu sản xuất lỗi', 'select', 'c_reworks', 1, 0, 0, 1, 0, '{\r\n	\"config\":{\r\n		\"searchbox\":1\r\n	},\r\n	\"data\":{\r\n		\"options\":{\r\n			\"\":\"Chọn tổ máy\",\r\n			\"print\":\"Tổ in\", \r\n			\"nilon\":\"Cán màng\", \r\n			\"metalai\":\"Tổ cán metalai\",\r\n			\"compress\":\"Tổ ép nhũ\",\r\n			\"float\":\"Tổ thúc nổi\",\r\n			\"uv\":\"Tổ in UV\",\r\n			\"elevate\":\"Tổ bế\",\r\n			\"peel\":\"Tổ bóc lề\",\r\n			\"mill\":\"Tổ máy phay\",\r\n			\"cut\":\"Tổ máy xén\",\r\n			\"fill\":\"Tổ máy bồi\",\r\n			\"box_paste\":\"Tổ dán hộp giấy\",\r\n			\"bag_paste\":\"Tổ dán túi giấy\",\r\n			\"finish\":\"Tổ hoàn thiện cuối\"\r\n		}\r\n	}\r\n}', 1, 1, 1, '2023-06-15 06:55:51', '2024-04-09 23:20:37');
INSERT INTO `n_detail_tables` VALUES (316, 'worker', '', 'Công nhân', 'linking', 'c_reworks', 1, 0, 1, 1, 0, '{\r\n	\"config\":{\r\n		\"search\":1\r\n	},\r\n	\"data\":{\r\n		\"table\":\"w_users\"\r\n	}\r\n}', 1, 1, 1, '2023-06-15 06:55:51', '2024-04-09 23:20:38');
INSERT INTO `n_detail_tables` VALUES (317, 'status', '', 'Trạng thái', 'select', 'c_reworks', 1, 0, 1, 0, 0, '{\"data\":{\r\n		\"options\":{\"not_accepted\":\"Chờ xử lí\", \"submited\":\"Đã xử lí\"}\r\n	}\r\n}', 1, 1, 1, '2023-06-15 06:55:51', '2024-04-09 23:20:39');
INSERT INTO `n_detail_tables` VALUES (318, 'rework_status', '', 'Trạng thái sx', 'select', 'c_reworks', 1, 0, 1, 0, 0, '{\"data\":{\r\n		\"options\":{\"need_rework\":\"Cần sản xuất lại\", \"no_rework\":\"Không cần sản xuất lại\", \"reworked\":\"Đã sản xuất lại\"}\r\n	}\r\n}', 1, 1, 1, '2023-06-15 06:55:51', '2024-04-09 23:20:41');
INSERT INTO `n_detail_tables` VALUES (319, 'note', '', 'Ghi chú', 'textarea', 'c_reworks', 0, 0, 0, 0, 0, '', 1, 1, 1, '2023-06-15 06:55:51', '2024-04-09 23:20:33');
INSERT INTO `n_detail_tables` VALUES (320, 'created_at', '', 'Ngày gửi', 'datetime', 'c_reworks', 1, 0, 1, 1, 0, '', 1, 1, 1, '2023-06-15 06:55:51', '2024-04-09 23:20:42');
INSERT INTO `n_detail_tables` VALUES (322, 'qty', '', 'Số lượng', 'text', 'c_reworks', 1, 0, 1, 0, 0, '', 1, 0, 1, '2023-06-15 06:55:51', '2024-04-09 23:20:47');
INSERT INTO `n_detail_tables` VALUES (323, 'customer', '', 'Khách hàng', 'linking', 'orders', 1, 0, 1, 1, 0, '{\r\n	\"config\":{\r\n		\"search\":1\r\n	},\r\n	\"data\":{\r\n		\"table\":\"customers\"\r\n	}\r\n}', 1, 8, 1, '2023-05-26 03:19:12', '2024-04-23 16:32:35');
...
INSERT INTO `n_detail_tables` VALUES (327, 'group_paper', '', 'Dạng giấy', 'group', 'print_warehouses', 1, 1, 0, 1, 0, '', 1, 0, 1, '2023-05-23 14:41:40', '2024-05-03 12:12:26');
INSERT INTO `n_detail_tables` VALUES (328, 'group_size', '', 'KT khổ', 'group', 'print_warehouses', 1, 1, 0, 1, 0, '', 1, 0, 1, '2023-05-23 14:41:40', '2024-05-03 12:12:23');
INSERT INTO `n_detail_tables` VALUES (329, 'group_size', '', 'KT khổ', 'group', 'supply_warehouses', 1, 1, 0, 1, 0, '', 1, 0, 1, '2023-05-23 14:41:40', '2024-05-03 12:22:11');
INSERT INTO `n_detail_tables` VALUES (330, 'created_by', NULL, 'Chịu trách nhiệm', 'linking', 'warehouse_histories', 1, 1, 1, 1, 0, '{\r\n	\"config\":{\r\n		\"search\":1\r\n	},\r\n	\"data\":{\r\n		\"table\":\"n_users\"\r\n	}\r\n}', 1, 0, 1, '2023-04-08 00:08:00', '2024-05-02 23:31:20');
INSERT INTO `n_detail_tables` VALUES (331, 'action', '', 'Hành động', 'select', 'warehouse_histories', 1, 1, 1, 1, 0, '{\"data\":{\r\n		\"options\":{\"insert\":\"Thêm mới NVL\", \"update\":\"Nhập thêm NVL\"}\r\n	}\r\n}', 1, 0, 1, '2023-04-07 23:41:47', '2024-05-02 23:31:20');
INSERT INTO `n_detail_tables` VALUES (332, 'name', '', 'Tên NVL', 'text', 'warehouse_histories', 1, 0, 1, 1, 0, '', 1, 0, 1, '2023-06-15 06:55:51', '2024-05-02 23:31:20');
INSERT INTO `n_detail_tables` VALUES (333, 'qty', '', 'Số lượng', 'text', 'warehouse_histories', 1, 0, 1, 0, 0, '', 1, 0, 1, '2023-06-15 06:55:51', '2024-05-02 23:35:31');
INSERT INTO `n_detail_tables` VALUES (335, 'bill', '', 'Hóa đơn', 'filev2', 'warehouse_histories', 1, 0, 1, 0, 0, '', 1, 0, 1, '2023-06-15 06:55:51', '2024-05-02 23:35:01');
INSERT INTO `n_detail_tables` VALUES (336, 'new_qty', '', 'Tồn kho', 'text', 'warehouse_histories', 1, 0, 1, 0, 0, '', 1, 0, 1, '2023-06-15 06:55:51', '2024-05-02 23:35:31');
INSERT INTO `n_detail_tables` VALUES (337, 'created_at', '', 'Ngày thực hiện', 'datetime', 'warehouse_histories', 1, 0, 0, 1, 0, '', NULL, 0, 1, '2023-06-15 06:55:51', '2024-05-02 23:36:57');
