...
CREATE TABLE `n_tables`  (
  ...
  `admin_paginate` int(0) NULL DEFAULT NULL,
...
INSERT INTO `n_tables` VALUES (24, 'n_log_actions', 'Lịch sử thao tác', NULL, 10, 'history', NULL, NULL, '', '', '1', '', '2023-05-23 14:43:41', '2023-08-16 19:42:34');
...
INSERT INTO `n_tables` VALUES (33, 'supply_names', 'Tên phụ vật tư', NULL, 10, 'view', NULL, '', '1', '1', '1', '1', '2023-07-17 19:30:41', '2023-08-16 19:42:34');
INSERT INTO `n_tables` VALUES (34, 'papers', 'Vật tư giấy', NULL, 20, 'view', NULL, '', '0', '1', '0', '0', '2023-06-21 13:22:33', '2023-12-25 20:49:44');
INSERT INTO `n_tables` VALUES (35, 'supplies', 'Vật tư hộp cứng', NULL, 20, 'view', NULL, '', '0', '1', '0', '0', '2023-06-21 13:22:33', '2023-12-25 20:49:41');
INSERT INTO `n_tables` VALUES (36, 'fill_finishes', 'Bồi & hoàn thiện', NULL, 20, 'view', NULL, '', '0', '1', '0', '0', '2023-06-21 13:22:33', '2023-12-25 20:49:40');
INSERT INTO `n_tables` VALUES (37, 'product_styles', 'Kiểu hộp', '{\r\n	\"link\":\"view/product_categories\", \r\n	\"note\":\"Nhóm sản phẩm\"\r\n}', 20, 'view', NULL, '', '1', '1', '1', '1', '2023-06-21 13:22:33', '2023-09-20 15:05:49');
INSERT INTO `n_tables` VALUES (38, 'warehouse_providers', 'Nhà cung cấp vật tư', NULL, 10, 'view', NULL, '', '1', '1', '1', '1', '2023-07-17 19:30:41', '2023-08-16 19:42:34');
...
INSERT INTO `n_tables` VALUES (42, 'partners', 'Đối tác sản xuất', NULL, 10, 'view', NULL, NULL, '1', '1', '1', '1', '2023-04-23 11:30:46', '2023-08-16 19:42:33');
...
INSERT INTO `n_tables` VALUES (44, 'c_reworks', 'Yêu cầu sản xuất lại', NULL, 10, 'view', '', '[\r\n	{\r\n		\"type\":2,\r\n		\"icon\":\"check-square-o\",\r\n		\"note\":\"Khởi tạo lại đơn\", \r\n		\"class\":\"__confirm_rework\",\r\n		\"condition\":[\r\n			{\"key\":\"status\", \"value\":\"not_accepted\"}\r\n		]\r\n	},\r\n	{\r\n		\"type\":2,\r\n		\"icon\":\"circle-thin\",\r\n		\"note\":\"Không cần thiết sản xuất lại\", \r\n		\"class\":\"__not_need_rework\",\r\n		\"datas\":[\"name\", \"qty\"],\r\n		\"condition\":[\r\n			{\"key\":\"status\", \"value\":\"not_accepted\"}\r\n		]\r\n	}\r\n]', '0', '0', '1', '0', '2023-07-17 19:30:41', '2024-04-25 14:53:53');
INSERT INTO `n_tables` VALUES (45, 'warehouse_histories', 'Nguyên vật liệu (Xuất, nhập, tồn)', '', 10, 'view', NULL, '', '0', '0', '1', '0', '2023-07-14 03:17:55', '2023-08-16 19:43:11');
INSERT INTO `n_tables` VALUES (46, 'represents', 'Người liên hệ', NULL, 10, 'view', NULL, NULL, '1', '1', '1', '1', '2023-04-23 11:30:46', '2024-06-17 12:06:36');
