<div class="from_time col-4 mb_30 d-flex align-items-center border_right_eb">
	<label for="from_<?= $field["id"] ?>" class="mr-2 d-block mb-0 min_100"><?= $field['note'] ?> từ ngày:</label>
...
<div class="to_time col-4 mb_30 d-flex align-items-center border_right_eb">
	<label for="to_<?= $field['id'] ?>" class="mr-2 d-block mb-0 min_100"><?= $field['note'] ?> đến ngày:</label>
