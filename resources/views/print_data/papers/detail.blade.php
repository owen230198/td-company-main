@include('print_data.header', ['title' => 'Lệnh sản xuất - Giấy in'])
    ...
    <div class="mt-3">
        ...
        @if (!empty($nilon['act']))
            <p class="d-flex align-items-center mb-1 pb-1 border_bot_eb">
                ...
                <span class="ml-1 text-lowercase">: {{ getTextdataPaperStage(\TDConst::NILON, $nilon) }}</span>
            </p>     
        @endif
        ...
        @if (!empty($metalai['act']))
            <p class="d-flex align-items-center mb-1 pb-1 border_bot_eb">
                ...
                <span class="ml-1 text-lowercase">: {{ getTextdataPaperStage(\TDConst::METALAI, $metalai) }}</span>
            </p>     
        @endif
        ...
        @if (!empty($compress['act']))
            <p class="d-flex align-items-center mb-1 pb-1 border_bot_eb">
                ...
                <span class="ml-1 text-lowercase">: {{ getTextdataPaperStage(\TDConst::COMPRESS, $compress) }}</span>
            </p>     
        @endif
        ...
        @if (!empty($uv['act']))
            <p class="d-flex align-items-center mb-1 pb-1 border_bot_eb">
                ...
                <span class="ml-1 text-lowercase">: {{ getTextdataPaperStage(\TDConst::UV, $uv) }}</span>
            </p>     
        @endif
        ...
        @if (!empty($float['act']))
            <p class="d-flex align-items-center mb-1 pb-1 border_bot_eb">
                ...
                <span class="ml-1 text-lowercase">: {{ getTextdataPaperStage(\TDConst::FLOAT, $float) }}</span>
            </p>     
        @endif
        ...
        @if (!empty($fold['act']))
            <p class="d-flex align-items-center mb-1 pb-1 border_bot_eb">
                ...
                <span class="ml-1 text-lowercase">: {{ getTextdataPaperStage(\TDConst::FOLD, $fold) }}</span>
            </p>     
        @endif
        ...
        @if (!empty($box_paste['act']))
            <p class="d-flex align-items-center mb-1 pb-1 border_bot_eb">
                ...
                <span class="ml-1 text-lowercase">: {{ getTextdataPaperStage(\TDConst::BOX_PASTE, $box_paste) }}</span>
            </p>     
        @endif
        ...
        @if (!empty($bag_paste['act']))
            <p class="d-flex align-items-center mb-1 pb-1 border_bot_eb">
                ...
                <span class="ml-1 text-lowercase">: {{ getTextdataPaperStage(\TDConst::BAG_PASTE, $bag_paste) }}</span>
            </p>     
        @endif
    </div>
    ...
    <div class="print_print_data_content mt-4 pt-4 border_top_dashed">
        ...
        <div class="mt-3">
            ...
            <p class="d-flex align-items-center mb-1 pb-1 border_bot_eb">
                <i class="fa fa-asterisk mr-1 fs-14 color_yellow" aria-hidden="true"></i>
                <span class="w_220 d-block">Số màu in</span> 
                <span class="ml-1 text-lowercase">: {{ @\TDConst::PRINT_COLOR[$print['color']] }}</span>
            </p> 
            <p class="d-flex align-items-center mb-1 pb-1 border_bot_eb">
                <i class="fa fa-asterisk mr-1 fs-14 color_yellow" aria-hidden="true"></i>
            ...
            @if (!empty(@$print['note']))
                <p class="d-flex align-items-center mb-1 pb-1 border_bot_eb">
                    ...
                    <span class="ml-1 text-lowercase">: {{ @$print['note'] }}</span>
                </p> 
            @endif
            @if (!empty($size['materal']))
                <p class="d-flex align-items-center mb-1 pb-1 border_bot_eb">
                    <i class="fa fa-asterisk mr-1 fs-14 color_yellow" aria-hidden="true"></i>
                    <span class="w_220 d-block">Chất liệu giấy</span> 
                    <span class="ml-1 text-lowercase">: {{ getFieldDataById('name', 'materals', $size['materal']) }}</span>
                </p> 
            @endif 
            <p class="d-flex align-items-center mb-1 pb-1 border_bot_eb">
                <i class="fa fa-asterisk mr-1 fs-14 color_yellow" aria-hidden="true"></i>
                <span class="w_220 d-block">Định lượng</span> 
                <span class="ml-1 text-lowercase">: {{ $size['qttv'] }}</span>
            </p>
            <p class="d-flex align-items-center mb-1 pb-1 border_bot_eb">
                <i class="fa fa-asterisk mr-1 fs-14 color_yellow" aria-hidden="true"></i>
