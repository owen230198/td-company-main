...
@section('content')
    <div class="home_index mt-3">
        <div class="row">
            <div class="col-lg-6">
                <h2 class="fs-15 text-uppercase font_bold pb-1 mb-3 border_bot_eb">thống kê đơn hàng 12 tháng gần đây</h2>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="row row-7">
                        ...
                        <div class="col-lg-6 mb-3">
                            <a href={{ asset('get-data-table-command/'.$table) }} class="main_item_command h-100 smooth d-flex align-items-center position-relative h-100">
                                ...
                                <div class="command_detail">
                                    ...
                                    <p class="fs-18 font_bold color_red">{{ getCountDataNotAcceptedTable($table) }}</p>
