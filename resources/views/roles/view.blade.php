...
<div class="dashborad_content pt-3 position-relative">
  <form action="get-permission" method="GET" class="formGetRole" enctype="multipart/form-data">
    <div class="form-group">
      <select name="group" class="form-control col-4 chose_group_admin">
            ...
            @foreach ($list_roles as $role)
              @if ($role['parent']==$parent['id'])
                <div class="col-md-3 mb_30">
                  ...
                  @endphp
                  <form action="update-permission/{{ $arr_role['module_id'].'/'.$arr_role['role_id'] }}" method="POST" enctype="multipart/form-data" class="border_main bg_white formDoUpdateRole">
                    @csrf
