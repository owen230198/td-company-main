...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/base/css/style.css?v=26') }}" />
    <link rel="stylesheet" href="{{ asset('frontend/admin/css/style.css?v=26') }}" />
    @yield('css')
</head>
...
<body>
    ...
    <script src="{{ asset('frontend/admin/script/script.js?v=26') }}"></script>
    @yield('script')
