...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/base/css/style.css?v=10') }}" />
    <link rel="stylesheet" href="{{ asset('frontend/admin/css/style.css?v=10') }}" />
    @yield('css')
</head>
...
<body>
    ...
    <script src="{{ asset('frontend/admin/script/script.js?v=10') }}"></script>
    @yield('script')
