...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/base/css/style.css?v=18') }}" />
    <link rel="stylesheet" href="{{ asset('frontend/admin/css/style.css?v=18') }}" />
    @yield('css')
</head>
...
<body>
    ...
    <script src="{{ asset('frontend/admin/script/script.js?v=18') }}"></script>
    @yield('script')
