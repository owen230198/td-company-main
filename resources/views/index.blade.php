...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/base/css/style.css?v=19') }}" />
    <link rel="stylesheet" href="{{ asset('frontend/admin/css/style.css?v=19') }}" />
    @yield('css')
</head>
...
<body>
    ...
    <script src="{{ asset('frontend/admin/script/script.js?v=19') }}"></script>
    @yield('script')
