...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/base/css/style.css?v=21') }}" />
    <link rel="stylesheet" href="{{ asset('frontend/admin/css/style.css?v=21') }}" />
    @yield('css')
</head>
...
<body>
    ...
    <script src="{{ asset('frontend/admin/script/script.js?v=21') }}"></script>
    @yield('script')
