...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/base/css/style.css?v=6') }}" />
    <link rel="stylesheet" href="{{ asset('frontend/admin/css/style.css?v=6') }}" />
    @yield('css')
</head>
...
<body>
    ...
    <script src="{{ asset('frontend/admin/script/script.js?v=6') }}"></script>
    @yield('script')
