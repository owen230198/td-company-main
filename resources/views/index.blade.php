...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/base/css/style.css?v=17') }}" />
    <link rel="stylesheet" href="{{ asset('frontend/admin/css/style.css?v=17') }}" />
    @yield('css')
</head>
...
<body>
    ...
    <script src="{{ asset('frontend/admin/script/script.js?v=17') }}"></script>
    @yield('script')
