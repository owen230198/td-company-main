...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/base/css/style.css?v=20') }}" />
    <link rel="stylesheet" href="{{ asset('frontend/admin/css/style.css?v=20') }}" />
    @yield('css')
</head>
...
<body>
    ...
    <script src="{{ asset('frontend/admin/script/script.js?v=20') }}"></script>
    @yield('script')
