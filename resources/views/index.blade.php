...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/base/css/style.css?v=22') }}" />
    <link rel="stylesheet" href="{{ asset('frontend/admin/css/style.css?v=22') }}" />
    @yield('css')
</head>
...
<body>
    ...
    <script src="{{ asset('frontend/admin/script/script.js?v=22') }}"></script>
    @yield('script')
