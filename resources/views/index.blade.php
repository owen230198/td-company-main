...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/base/css/style.css?v=28') }}" />
    <link rel="stylesheet" href="{{ asset('frontend/admin/css/style.css?v=28') }}" />
    @yield('css')
</head>
...
<body>
    ...
    <script src="{{ asset('frontend/admin/script/script.js?v=28') }}"></script>
    @yield('script')
