...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/base/css/style.css?v=9') }}" />
    <link rel="stylesheet" href="{{ asset('frontend/admin/css/style.css?v=9') }}" />
    @yield('css')
</head>
...
<body>
    ...
    <script src="{{ asset('frontend/admin/script/script.js?v=9') }}"></script>
    @yield('script')
