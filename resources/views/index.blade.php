...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/base/css/style.css?v=14') }}" />
    <link rel="stylesheet" href="{{ asset('frontend/admin/css/style.css?v=14') }}" />
    @yield('css')
</head>
...
<body>
    ...
    <script src="{{ asset('frontend/admin/script/script.js?v=14') }}"></script>
    @yield('script')
