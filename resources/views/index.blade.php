...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/base/css/style.css?v=23') }}" />
    <link rel="stylesheet" href="{{ asset('frontend/admin/css/style.css?v=23') }}" />
    @yield('css')
</head>
...
<body>
    ...
    <script src="{{ asset('frontend/admin/script/script.js?v=23') }}"></script>
    @yield('script')
