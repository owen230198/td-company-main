...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/base/css/style.css?v=25') }}" />
    <link rel="stylesheet" href="{{ asset('frontend/admin/css/style.css?v=25') }}" />
    @yield('css')
</head>
...
<body>
    ...
    <script src="{{ asset('frontend/admin/script/script.js?v=25') }}"></script>
    @yield('script')
