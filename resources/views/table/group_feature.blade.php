<div class="d-flex align-center justify-content-end my-1 flex-wrap">
    <button type="submit"
        class="main_button my-1 bg_main color_white smooth bg_green border_green radius_5 font_bold smooth mr-2"
    ...
    @if (@$tableItem['export'] == 1)
        <button data-table = {{ @$tableItem['name'] }}
            class="main_button my-1 bg_main color_white smooth bg_green border_green radius_5 font_bold smooth mr-2 __base_export_btn">
    ...
    @if (@$tableItem['import'] == 1)
        <div class="__import_excel_module possition-relative">
            ...
            <button class="main_button my-1 bg_main color_white smooth bg_green border_green radius_5 font_bold smooth mr-2 __import_button_btn">
    ...
    @if (@$tableItem['insert'] == 1)
        ...
        @if (hasNoSidebarParam())
            ...
            class="btn btn-primary main_button my-1 bg_main color_white smooth bg_green border_green radius_5 font_bold smooth ml-2 load_view_popup mr-2" 
    ...
    @endif
    @if (@$tableItem['remove'])
        <button class="main_button my-1 bg_red color_white smooth radius_5 font_bold smooth red_btn d-lg-block d-none" data-toggle="modal"
    ...
    class="btn btn-primary main_button my-1 bg_main color_white smooth bg_green border_green radius_5 font_bold smooth ml-2 load_view_popup" 
    data-toggle="modal" data-target="#actionModal">
    ...
    @if (!empty(@$tableItem['ext_fucn']))
        ...
        @endforeach
    @endif
    <a href="javascript:void(0)" class="main_button my-1 bg_main color_white smooth bg_green border_green radius_5 font_bold smooth ml-2 d-lg-block d-none">
