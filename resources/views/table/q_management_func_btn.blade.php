<div class="d-flex flex-wrap justify-content-center">
	<button class="table-btn mb-2 fs-20 mr-2 load_view_popup" data-toggle="modal" data-target="#actionModal" data-src="update-detail-quotes/{{ $tableItem['name'].'/'.$data_quotes['id'] }}/{{ $data['id'] }}">
