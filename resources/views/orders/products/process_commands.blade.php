...
@endphp
<div class="cogfig_process_command bg_eb mb-4">
        ...
        <div class="command_config_detail">
            ...
            <div class="row justify-content-around">
                ...
                <div class="form-group d-flex mb-3 pb-3 border_bot_eb col-4">
                    <label class="mb-0 mr-3 w_150 fs-13 text-capitalize">Ngày đặt gia công</label>
                ...
                <div class="form-group d-flex mb-3 pb-3 border_bot_eb col-4">
                    <label class="mb-0 mr-3 w_150 fs-13 text-capitalize">Ngày xong</label>
