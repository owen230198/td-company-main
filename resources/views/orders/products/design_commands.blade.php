    ...
    <div class="p-3 config_detail">
        <div class="row command_config_detail">
            <div class="form-group d-flex mb-3 pb-3 border_bot_eb col-12">
                ...
                <input type="text" class="form-control" name="{{ $singleObject?'name':'c_design['.$key.'][name]' }}" 
            ...
            <div class="form-group d-flex mb-3 pb-3 border_bot_eb col-4">
                ...
                <select name="{{ $singleObject?'num_color':'c_design['.$key.'][num_color]' }}" class="form-control" required>
            ...
            <div class="form-group d-flex mb-3 pb-3 border_bot_eb col-4">
                ...
                <select name="{{ $singleObject?'num_face':'c_design['.$key.'][num_face]' }}" class="form-control" required>
            ...
            <div class="form-group d-flex mb-3 pb-3 border_bot_eb col-4">
                ...
                <select name="{{ $singleObject?'type':'c_design['.$key.'][type]' }}" class="form-control">
            ...
            <div class="form-group d-flex mb-3 pb-3 border_bot_eb col-4">
                ...
                <select name="{{ $singleObject?'style':'c_design['.$key.'][style]' }}" class="form-control design_style_order" required>
            ...
            <div class="form-group d-flex mb-3 pb-3 border_bot_eb col-4">
                ...
                <select name="{{ $singleObject?'print_style':'c_design['.$key.'][print_style]' }}" class="form-control" required>
            ...
            <div class="form-group d-flex mb-3 pb-3 border_bot_eb col-4">
                ...
                <select name="{{ $singleObject?'print_color':'c_design['.$key.'][print_color]' }}" class="form-control" required>
            ...
            <div class="form-group d-flex mb-3 pb-3 border_bot_eb col-4">
                ...
                <select name="{{ $singleObject?'custom_sending':'c_design['.$key.'][custom_sending]' }}" class="form-control">
            ...
            <div class="form-group d-flex mb-3 pb-3 border_bot_eb col-4">
                ...
                <input type="text" name="{{ $singleObject?'demo_expired':'c_design['.$key.'][demo_expired]' }}" value="" 
                class="form-control max_w_200 inputDatePicker">
            </div>
            <div class="form-group d-flex mb-3 pb-3 border_bot_eb col-4">
                <label class="mb-0 mr-3 w_125 fs-13 text-capitalize">Hạn hoàn thành</label>
                <input type="text" name="{{ $singleObject?'expired':'c_design['.$key.'][expired]' }}" value="" 
                class="form-control max_w_200 inputDatePicker">
            </div>
            <div class="form-group d-flex border_bot_eb col-12">
                ...
                <textarea class="form-control" name="{{ $singleObject?'note':'c_design['.$key.'][note]' }}"></textarea>
            </div>
            <div class="col-12 text-center customer_file_upload" style="display:none">
                <div class="upload_click position-relative">
                    ...
                    <input type="file" name="{{ $singleObject?'file':'c_design['.$key.'][file]' }}" value="" class="upload_input file_input">
                </div>
            </div>
        </div>
    </div>
