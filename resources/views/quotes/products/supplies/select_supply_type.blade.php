@php
    $pro_supply = [
        ...
        'attr' => ['required' => 1, 'inject_class' => 'select_supply_type', 'inject_attr' => 'cvalue = '.@$supply_size['supply_price'], 'disable_field' => !empty($disable_all)],
    ...
    $pro_supp_price = [
        ...
        'attr' => ['required' => 1, 'inject_class' => 'ajax_supply_price', 'disable_field' => !empty($disable_all)],
