...
<div class="d-flex align-items-center mb-2 fs-13">
    <label class="mb-0 min_210 text-capitalize text-right mr-3">
        <span class="fs-15 mr-1">*</span>Kích thước khổ vật tư
    </label>
    <div class="d-flex justify-content-between align-items-center">
        <input type="number" name = '{{ $base_name }}[length]' placeholder="Chiều dài (cm)" 
        class="form-control medium_input" step="any" value="{{ @$value['length'] }}"
        ...
        class="form-control medium_input" step="any"value="{{ @$value['width'] }}"
        ...
        @if (!empty($other_materal))
            <div class="paper_price_config_input">
                <div class="d-flex align-items-center">
                    ...
                    class="form-control medium_input price_input_paper" step="any" value="{{ @$value['unit_price'] }}">
