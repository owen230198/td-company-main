@php
    ...
    $key_cover = \TDConst::COVER;
    $paper_cover_face = [
        'name' => $paper_hd_base_name.'['.$key_cover.'][face]',
        'type' => 'select',
...
@include('quotes.products.select_supply_type', ['key_supp' => $key_supp, 'pro_index' => $pro_index, 'supp_index' => $supp_index, 'key_stage' => $key_stage, 'key_type' => $key_stage, 'value' => @$data_handle])

@include('view_update.view', $paper_metalai_face)

@include('quotes.products.select_supply_type', ['key_supp' => $key_supp, 'pro_index' => $pro_index, 'supp_index' => $supp_index, 'key_stage' => $key_cover, 'key_type' => $key_cover, 'value' => @$data_handle_cover])
