    ...
    <div class="d-flex align-items-center">
        <div class="size_item_pro_structure">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <input type="number" name = 'product[{{ $pro_index }}][paper][{{ $supp_index }}][pro_size][length]' 
        ...
        <div class="size_item_pro_structure">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <input type="number" name = 'product[{{ $pro_index }}][paper][{{ $supp_index }}][pro_size][width]' 
        ...
        <div class="size_item_pro_structure">
            ...
            <div class="d-flex justify-content-between align-items-center height_input">
                <input type="number" name = 'product[{{ $pro_index }}][paper][{{ $supp_index }}][pro_size][height]' 
...
@php
    $quote_size_pro_side = [
        'name' => 'product['.$pro_index.'][paper]['.$supp_index.'][pro_size][lid_bottom_type]',
...
<div class="form-group d-flex mb-2">
    ...
    <div class="d-flex align-items-center">
        <div class="d-flex justify-content-between align-items-center">
            <input type="number" name = 'product[{{ $pro_index }}][paper][{{ $supp_index }}][pro_size][lid]' 
            placeholder="Nhập KT nắp" class="form-control medium_input text-center struture_pro_input" step="any"
            value="{{ @$pro_size['lid'] }}">
        </div>
        <span class="mx-3">--</span>
        <div class="d-flex justify-content-between align-items-center">
            <input type="number" name = 'product[{{ $pro_index }}][paper][{{ $supp_index }}][pro_size][bottom]' 
...
@php
    $quote_size_edge = [
        'name' => 'product['.$pro_index.'][paper]['.$supp_index.'][pro_size][edge]',
        'note' => 'KT mép dán',
        'type' => 'text',
...
<div class="form-group d-flex mb-2">
    ...
    <div class="d-flex align-items-center">
        <div class="d-flex justify-content-between align-items-center">
            <input type="number" name = 'product[{{ $pro_index }}][paper][{{ $supp_index }}][pro_size][nqty_length]' 
        ...
        <span class="mx-3">=</span>
        <div class="d-flex justify-content-between align-items-center">
            <input type="number" name = 'product[{{ $pro_index }}][paper][{{ $supp_index }}][pro_size][size_length]' 
...
<div class="form-group d-flex mb-2">
    ...
    <div class="d-flex align-items-center">
        <div class="d-flex justify-content-between align-items-center">
            <input type="number" name = 'product[{{ $pro_index }}][paper][{{ $supp_index }}][pro_size][nqty_height]' 
        ...
        <span class="mx-3">=</span>
        <div class="d-flex justify-content-between align-items-center">
            <input type="number" name = 'product[{{ $pro_index }}][paper][{{ $supp_index }}][pro_size][size_height]' 
...
@php
    $quote_size_nqty_space = [
        'name' => 'product['.$pro_index.'][paper]['.$supp_index.'][pro_size][nqty_space]',
...
@php
    $quote_size_nqty = [
        'name' => 'product['.$pro_index.'][paper]['.$supp_index.'][pro_size][nqty]',
        'note' => 'Số bát/tờ in',
        'type' => 'text',
...
@php
    $quote_size_min = [
        'name' => 'product['.$pro_index.'][paper]['.$supp_index.'][pro_size][min_paper_size]',
...
<div class="form-group d-flex mb-2">
    ...
    <div class="d-flex align-items-center">
        <div class="d-flex justify-content-between align-items-center">
            <input type="number" name = 'product[{{ $pro_index }}][paper][{{ $supp_index }}][pro_size][temp_length]' 
        ...
        <span class="mx-3">X</span>
        <div class="d-flex justify-content-between align-items-center">
            <input type="number" name = 'product[{{ $pro_index }}][paper][{{ $supp_index }}][pro_size][temp_height]' 
...
@php
    $quote_optimal_paper_lot = [
        'name' => 'product['.$pro_index.'][paper]['.$supp_index.'][pro_size][paper_lot]',
        'attr' => ['inject_class' => 'struture_pro_input'],
...
<div class="d-flex align-items-end">
    ...
    <div class="group_btn_action_form_compute_size d-flex align-items-center mb-2 ml-5">
        ...
        smooth auto_computed_btn" data-proindex={{ $pro_index }} data-paperindex={{ $supp_index }} >
