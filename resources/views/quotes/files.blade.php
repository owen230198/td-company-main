...
{!! getBreadcrumb('', 0, 'File báo giá') !!}
	<div class="dashborad_content bg_white">
	 	<div class="quote_model py-lg-5 py-4">
			...
			<div class="px-lg-5 position-relative quote_content">
				<div class="quote_bg_content">
					...
					<p class="fs-17 ml-lg-5 ml-md-3 mb-1">Kính gửi : <span class="font-italic"><span class="company">{{ $data_quotes['customer'] }}</span></span></p>
						      		...
						      		@if (@$print->act == 1)	
							      		<p class="d-flex align-items-center mb-1 font_w_bold">
							      			<span class="mr-1">
							      				...
							      				In: In {{ @$print->device==1?'print':'uv' }} theo {{ @$data_quotes['print_model']==2?'file đã sản xuất':'file thiết kế mới' }}
							      			</span>	
							      		</p>
						      		@endif
						      		<p class=" mb-1">
		...
		<div class="form_btn_group my-lg-4 pt-lg-4 my-3 pt-3 w-100 text-center">
			<button class="btn basic_btn color_white main_bg mr-lg-3 mr-2 mb-lg-0 mb-2 print_quotes">Xuất báo giá</button>
			<a href="quote-managements/q_papers/{{ $data_quotes['id'] }}" class="btn basic_btn color_white main_bg mr-lg-3 mr-2 mb-lg-0 mb-2">Xem chi tiết</a>
			<a href="" class="btn basic_btn color_white main_bg mr-lg-3 mr-2 mb-lg-0 mb-2">Gửi báo giá</a>
			<a href="{{ url('') }}" class="btn basic_btn color_white main_bg cancel_btn">Thoát</a>	
		</div>   
	</div>
@endsection