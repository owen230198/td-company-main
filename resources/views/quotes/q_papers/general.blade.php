...
<div class="d-flex align-items-center mb-4">
  ...
  <div class="d-flex align-items-center fs-15 mr-3 mb-md-0 mb-3">
    <div class="form-group d-flex align-items-center mb-0">
      <select name="design_model" class="form-control short_input">
    ...
    <div class="form-group d-flex align-items-center mb-0">
      <input class="form-control fs-15 short_input x_short_input" placeholder="Nhập Giá TK" type="number" name="design_price" value="" min="0">
    </div>
  </div>
</div>