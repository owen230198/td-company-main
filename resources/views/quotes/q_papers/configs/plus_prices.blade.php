...
<div class="incredent_content mt-4" style="display: {{ @$data_plus['act']?'block':'' }};">
  <div class="d-flex align-items-center mb-3">
    ...
    <input class="form-control fs-15 short_input" type="number" name="plus[price]" value="{{ @$data_plus['price']?$data_plus['price']:'' }}" min="0">
  </div>
  <h4 class="fs-15 font-bold color_red">Dành cho điền giá 1 sản phẩm</h4> 
