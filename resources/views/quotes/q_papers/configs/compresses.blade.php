...
<div class="incredent_content mt-4" style="display: {{ @$data_compress['act']?'block':'' }};">
  <div class="d-flex align-items-center mb-3">
    ...
    <div class="d-block">
      <input class="form-control fs-15 short_input" type="number" name="compress[price]" value="{{ @$data_compress['price'] }}" min="0">
  ...
  <div class="d-flex align-items-center mb-3">
    ...
    <div class="d-block">
      <input class="form-control fs-15 short_input" type="number" name="compress[shape]" value="{{ @$data_compress['shape'] }}" min="0">
