    ...
    <div class="d-flex align-items-center fs-15 mr-3 mb-md-0 mb-3 group_select_other">
      <div class="form-group mb-0 ">
        ...
        <div class="input_add mt-1" style="display: {{ @$data_skin['materal']=='other'?'block':'' }};">
          <input class="form-control fs-15 short_input x_short_input" placeholder="Nhập chi phí" type="number" name="skin[materal_price]" value="{{ @$data_skin['materal_price']?$data_skin['materal_price']:'' }}" min="0" {{ @$data_skin['materal']!='other'?'disabled':'' }}>
        </div>
      </div>
    </div>
  </div>   
