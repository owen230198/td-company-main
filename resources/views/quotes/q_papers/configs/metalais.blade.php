    ...
    <div class="d-flex align-items-center fs-15 mr-3 mb-md-0 mb-3 group_select_other">
      <div class="form-group mb-0">
        ...
        <div class="input_add mt-1" style="display: {{ @$data_metalai['materal']=='other'?'block':'' }};">
          <input class="form-control fs-15 short_input" placeholder="Nhập chi phí" type="number" name="metalai[materal_price]" value="{{ @$data_metalai['materal_price']?$data_metalai['materal_price']:'' }}" min="0" {{ @$data_metalai['materal']!='other'?'disabled':'' }}>
        </div>
      </div>
    </div>
  </div>   
    ...
    <div class="d-flex align-items-center fs-15 mr-3 mb-md-0 mb-3 group_select_other">
      <div class="form-group mb-0">
        ...
        <div class="input_add mt-1" style="display: {{ @$data_metalai['cover_materal']=='other'?'block':'' }};">
          <input class="form-control fs-15 short_input" placeholder="Nhập chi phí" type="number" name="metalai[cover_materal_price]" value="{{ @$data_metalai['cover_materal_price']?$data_metalai['cover_materal_price']:'' }}" min="0" {{ @$data_metalai['cover_materal']!='other'?'disabled':'' }}>
        </div>
      </div>
    </div>
  </div>   
