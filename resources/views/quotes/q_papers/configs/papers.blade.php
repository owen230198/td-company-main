...
<div class="d-flex align-items-center mb-4">
  ...
  <div class="d-flex align-items-center fs-15 mr-3 mb-md-0 mb-3">
    <div class="form-group d-flex align-items-center mb-0">
      <input class="form-control fs-15 short_input" placeholder="Nhập ĐL giấy" type="number" name="paper_size[quantitative]" value="{{ @$data_paper['quantitative']?$data_paper['quantitative']:'' }}" min="0" required step="any">
      <span class="d-sm-flex font_bold mx-lg-3 mx-2">-</span>
    </div>
    <div class="form-group d-flex align-items-center mb-0">
      <input class="form-control fs-15 short_input" placeholder="Nhập ĐG tấn" type="number" name="paper_size[unit_price]" value="{{ @$data_paper['unit_price']?$data_paper['unit_price']:'' }}" min="0" required step="any">
    </div>
  </div>
</div>
<div class="d-flex align-items-center mb-4 group_select_other">
  ...
  <div class="d-flex align-items-center fs-15 mr-3 mb-md-0 mb-3">
    ...
    <div class="input_add" style="display: {{ @$data_design['type']==1?'block':'' }}">
      <div class="form-group d-flex align-items-center mb-0">
        <span class="d-sm-flex font_bold mx-lg-3 mx-2">-</span>
        <input class="form-control fs-15 short_input x_short_input" placeholder="Nhập Giá TK" type="number" name="design_model[total]" value="{{ @$data_design['total']?$data_design['total']:'' }}" min="0" {{ @$data_design['type']!=1?'disabled':'' }} step="any">
      </div>
    </div>
  </div>
</div>