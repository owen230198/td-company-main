    ...
    @if (\GroupUser::isAdmin())
        ...
        @if (@$stage['color'] == \TDConst::APLA_PRINT_COLOR)
            ...
            <div class="formula_item d-flex align-items-center color_brown mb-1">
                ...
                <div class="formula_content d-flex align-items-center">
                    <p class="formula_param mx-2">(Số lượng tờ in x Chi phí in apla) + Chi phí cộng thêm khi in apla</p>
        ...
        @endif
    @else
    <p class="fs-15 color_red font_bold">Tổng chi phí in = {{ number_format($stage['total']) }}đ</p>       
    @endif
</div>