...
<div class="mt-2 pt-2 border_top_thin formula_tab">
    ...
    <div class="formula_item d-flex align-items-center color_brown mb-1">
        ...
        <div class="formula_content d-flex align-items-center">
            <p class="formula_param mx-2">
                Dài ({{ $size['length'] }}) x Rộng x ĐG vật tư x SL sản phẩm cả BH  x Hệ số
            </p>
            <p class="font_bold formula_result mr-2"> = {{ $size['length'] }} x {{ $size['width'] }} x 0 x {{ $stage['qty_pro'] }} x 1</p>
            <p class="font_bold formula_result"> = {{ number_format($size['length'] * $size['width'] * 0 * $stage['qty_pro']) }}đ</p>
        </div>
    </div>   
    <div class="formula_item d-flex align-items-center color_brown mb-1">
    ...
    <div class="formula_item d-flex align-items-center color_brown mb-1">
        ...
        <div class="formula_content d-flex align-items-center">
            ...
            <p class="font_bold formula_result"> = {{ $stage['qty_pro'] }} x {{ $stage['work_price'] }} x 1</p>
